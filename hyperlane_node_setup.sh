...
echo "  - 생성될 지갑의 Private Key를 안전하게 보관할 것"
...
echo "또한, https://basescan.org/ 에 접속하여 생성된 지갑 주소로 트랜잭션이 발생하는지 확인하면 구축이 완료된 것입니다."
echo "----------------------------------------------"
